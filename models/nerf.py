...
class NeRF(nn.Module):
    def __init__(self,
                 ...
                 deformation_dim=0, apperance_dim=0,
        ...
        self.in_channels_dir = apperance_dim
        if self.use_view:
    ...
    def forward(self, xyz, viewdir=None, deformation_code=None, apperance_code=None):
        """
        Inputs:
        ...
        if self.apperance_dim > 0:
            dir_encoding_input = torch.cat([dir_encoding_input, apperance_code], -1)
