    ...
    def forward(
        ...
        **kwargs
        ...
        global_orient = (global_orient if global_orient is not None else
                         self.global_orient.expand(batch_size, -1))
    ...
    def forward(
        ...
        **kwargs
        ...
        left_hand_pose = (left_hand_pose if left_hand_pose is not None else
                          self.left_hand_pose.expand(batch_size, -1))
        right_hand_pose = (right_hand_pose if right_hand_pose is not None else
                           self.right_hand_pose.expand(batch_size, -1))
...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        **kwargs
        ...
        right_hand_pose = (right_hand_pose if right_hand_pose is not None else
                           self.right_hand_pose.expand(batch_size, -1))
        jaw_pose = jaw_pose if jaw_pose is not None else self.jaw_pose.expand(batch_size, -1)
        leye_pose = leye_pose if leye_pose is not None else self.leye_pose.expand(batch_size, -1)
        reye_pose = reye_pose if reye_pose is not None else self.reye_pose.expand(batch_size, -1)
        expression = expression if expression is not None else self.expression.expand(batch_size, -1)
